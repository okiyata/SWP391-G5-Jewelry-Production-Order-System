...
public enum OrderEvent {
    ...
    DELIVERED,              //TRANSITION FROM ON_DELIVERING TO DELIVERED_AWAIT_APPROVAL
    DELIVERED_PROCESS,      //TRANSITION FROM DELIVERED_AWAIT_APPROVAL TO DELIVERED_APPROVAL_PROCESS
    DELIVERED_APPROVE,      //TRANSITION FROM DELIVERED_CONFIRMED TO ORDER_COMPLETED
    DELIVERED_DENY,         //TRANSITION FROM DELIVERED_DENIED TO ON_DELIVERING
